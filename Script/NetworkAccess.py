...
dataLogin = {
    'userId': '22420301870541',  # 填写post请求中的账号
    'password': '',
    # 填写post请求中加密过的密码
    'service': 'after-auth',  # 选择网络接入方式，在post请求中有
    'queryString': 'wlanuserip%3D10.100.4.143%26wlanacname%3D%26nasip%3D172.10.1.1%26wlanparameter%3Da0-36-9f-8a-3e-fe%26url%3Dhttp%3A%2F%2F123.123.123.123%2F%26userlocation%3Dethtrunk%2F200%3A1597.103',
    # 从post请求中复制过来即可
    'operatorPwd': '',  # 不用填
    'operatorUserId': '',  # 不用填
    'validcode': '',  # 不用填
    'passwordEncrypt': 'true',  # 不用修改
    'userIndex': '61623630336231626232373438666264663533346233396637396463393839645f31302e3130302e342e3130305f3232343230333031383730353431'
    # 填写post请求中的对应字段
}
...
login = 'http://10.80.1.122/eportal/InterFace.do?method=login'  # 登录地址
checkStatus = 'http://10.80.1.122/eportal/InterFace.do?method=getOnlineUserInfo'  # 验证地址
